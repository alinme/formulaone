...
export const priceFaqDataMap: Record<string, FAQItem[]> = {
  ...
  en: [
    {
      id: "item-1",
      question: "What is included in General Admission?",
      answer:
        "General Admission gives you full weekend access to the circuit, grandstand seating, and access to fan zones. It's the perfect way to experience a Grand Prix weekend.",
    },
    {
      id: "item-2",
      question: "How much does Paddock Club cost?",
      answer:
        "Paddock Club packages start at $30 per race. They include premium hospitality, paddock access, driver appearances, and exclusive paddock tours.",
    },
    {
      id: "item-3",
      question: "What does VIP Hospitality include?",
      answer:
        "VIP Hospitality packages are available from $60 per race. They offer the ultimate experience including pit lane access, garage tours, and dedicated hospitality hosting.",
    },
    {
      id: "item-4",
      question: "Do you offer season packages?",
      answer:
        "Yes, we offer Season Pass options for even more savings. The Paddock Club Season Pass is $288 per year, and the VIP Season Pass is $600 per year.",
    },
    {
      id: "item-5",
      question: "Can I upgrade my package?",
      answer:
        "Upgrades are subject to availability. Contact our team to check options for upgrading from General Admission to Paddock Club or VIP Hospitality.",
    },
  ],
  ja: [
    {
