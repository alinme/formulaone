  ...
  en: [
    {
      ...
      description: "Grandstand Experience",
      benefits: [
        "Full weekend access",
        "Grandstand seating",
        "Access to fan zones",
    ...
    },
    {
      ...
      benefits: [
        "Paddock Club access",
        "Premium seating and catering",
        "Driver appearances",
        "Exclusive paddock tours",
        "Premium parking",
      ],
      limitations: [
        "Subject to availability",
        "Circuit-specific packages",
      ],
      prices: {
        monthly: 30,
        yearly: 288,
    ...
    },
    {
      ...
      description: "Ultimate Race Weekend",
      benefits: [
        "Full VIP experience",
        "Pit lane and paddock access",
        "Team garage tours",
