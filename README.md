...
An easy-to-use Next.js website template (simplified—no database, auth, or Stripe).

This fork keeps only the marketing website: homepage, blog, pricing, and docs. You can browse and extend it as a normal static/marketing site.
...
Demo Server (Location: Washington - USA): <https://show.f1.onl>

See more documentation at <https://document.f1.onl>
...
1. [Bun](https://bun.sh/) (or npm) & [Node.js](https://nodejs.org/) & [Git](https://git-scm.com/)
...
1. Copy env and set `NEXT_PUBLIC_APP_URL`:
...
1. Admin Dashboard Page (in alpha !!!)
    ...
    2. You can provide your admin account and change **ADMIN_EMAIL="admin@f1.onl,root@f1.onl"** in .env.local and access host:port/admin/dashboard
...
[discord-badge]: https://img.shields.io/discord/1204690198382911488?color=7b8dcd&link=https%3A%2F%2Ff1.onl%2Fdiscord
